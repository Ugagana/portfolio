        ...
        <div className="experience-container">
          ...
          >
            <div className="experience-image-container">
              <img src="/images/BFI.jpg" alt="Better Futures Logo" className="experience-image" />
            </div>
          ...
          >
            <div className="experience-image-container">
              <img src="/images/lowes.png" alt="Lowes India Logo" className="experience-image" />
            </div>
            <div className="content">
              <h3>Senior Analyst</h3>
              <h4>Lowes India</h4>
          ...
          >
            <div className="experience-image-container">
              <img src="/images/amazon.png" alt="Amazon Logo" className="experience-image" />
            </div>
            <div className="content">
              <h3>Senior Product Compliance Associate</h3>
              <h4>Amazon.in</h4>
          ...
          >
            <div className="experience-image-container">
              <img src="/images/target.jpg" alt="Target Logo" className="experience-image" />
            </div>
            <div className="content">
              <h3>Lead Item Data Specialist</h3>
              <h4>Target Corporation</h4>
          ...
          >
            <div className="experience-image-container">
              <img src="/images/technosoft.jpg" alt="Technosoft Logo" className="experience-image" />
            </div>
            <div className="content">
              <h3>Data Analyst</h3>
              <h4>Technosoft Global Corporation – Target Corporation</h4>
          ...
          >
            <div className="experience-image-container">
              <img src="/images/mydeals.png" alt="MyDeals247 Logo" className="experience-image" />
            </div>
            <div className="content">
              <h3>Business Development Manager</h3>
              <h4>MyDeals247 Pvt. ltd</h4>
